...
#include <memory>
#include "../../Client/cartitemwidget.h"
...
void CartItemWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CartItemWidget::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CartItemWidget::countChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CartItemWidget::*)(int );
