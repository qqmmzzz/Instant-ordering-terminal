...
void MyTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::connectFailed)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (MyTcpClient::*)(const QJsonArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::menuReceived)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (MyTcpClient::*)(bool , int , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::orderResult)) {
                *result = 4;
                return;
            }
        }
