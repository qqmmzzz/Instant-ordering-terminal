...
void ThemeManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ThemeManager::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThemeManager::themeChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ThemeManager::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThemeManager::backgroundChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject ThemeManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ThemeManager.data,
      qt_meta_data_ThemeManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
