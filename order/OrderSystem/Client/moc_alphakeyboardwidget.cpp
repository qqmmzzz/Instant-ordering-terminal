...
void AlphaKeyboardWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AlphaKeyboardWidget *_t = static_cast<AlphaKeyboardWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject AlphaKeyboardWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AlphaKeyboardWidget.data,
      qt_meta_data_AlphaKeyboardWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AlphaKeyboardWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AlphaKeyboardWidget.stringdata0))
        return static_cast<void*>(const_cast< AlphaKeyboardWidget*>(this));
